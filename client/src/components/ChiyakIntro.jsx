...
const ChiyakIntro = () => (
  <div>
    ...
    <Row>
      <Col md={1} mdOffset={0.5} className="intro">
        <img className="drchoi" src={drchoi} alt="#" />
      </Col>
      <Col md={5.5} mdOffset={1} className="intro">
        <Jumbotron className="jum1">
          ...
          <p>은은하면서 상쾌한 느낌을 주며, 다양한 약성 성분의 천연 추출물 및 오일로</p>
          <p>입냄새 제거 및 구강건강에 도움을 줍니다</p>
          <h3>더 이상 거품효과에 속지 마세요!</h3>
          <p>닥터초이스 좋은치약은 저자극치약으로</p>
          <p>일반인은 물론 입안이 아파서 칫솔질을 할 수 없는 환자도 사용할 수 있으며</p>
